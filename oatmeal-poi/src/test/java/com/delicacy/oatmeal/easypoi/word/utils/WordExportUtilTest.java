package com.delicacy.oatmeal.easypoi.word.utils;
	...
	public void test_total() {
		...
		try {
			...
			FileOutputStream fos = new FileOutputStream(
					"src/test/resources/com/delicacy/oatmeal/easypoi/word/utils/wordexport_contract_2.docx");
			doc.write(fos);
			fos.close();
		} catch (Exception e) {
			e.printStackTrace();
		...
		try {
			XWPFDocument doc = WordExportUtil
					.exportWord07(
							...
							map);
			FileOutputStream fos = new FileOutputStream(
					"src/test/resources/com/delicacy/oatmeal/easypoi/word/utils/wordexport_excel_2.docx");
			doc.write(fos);
			fos.close();
		} catch (Exception e) {
			e.printStackTrace();
		...
		try {
			XWPFDocument doc = WordExportUtil
					.exportWord07(
							...
							map);
			FileOutputStream fos = new FileOutputStream(
					"src/test/resources/com/delicacy/oatmeal/easypoi/word/utils/wordexport_image_2.docx");
			doc.write(fos);
			fos.close();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void test_map() {
		...
		try {
			XWPFDocument doc = WordExportUtil.exportWord07(
					...
					map);
			FileOutputStream fos = new FileOutputStream(
					"src/test/resources/com/delicacy/oatmeal/easypoi/word/utils/workexport_map_2.docx");
			doc.write(fos);
			fos.close();
		} catch (Exception e) {
			e.printStackTrace();
