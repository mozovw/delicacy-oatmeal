...
import com.delicacy.oatmeal.easypoi.excel.entity.HyperLinkEntity;
...
public class ExcelExportUtilTest  {
	...
	public void testExportExcel() throws Exception {
		...
		FileOutputStream fos = new FileOutputStream(
				"src/test/resources/com/delicacy/oatmeal/easypoi/excel/util/excelexport.xlsx");
		workbook.write(fos);
		fos.close();
	}
	...
	public void test_link() throws Exception {
		...
		FileOutputStream fos = new FileOutputStream(
				"src/test/resources/com/delicacy/oatmeal/easypoi/excel/util/excelexport_link.xls");
		workbook.write(fos);
		fos.close();
	}
	...
	public void test_merge() {
		try {
			...
			FileOutputStream fos = new FileOutputStream(
					"src/test/resources/com/delicacy/oatmeal/easypoi/excel/util/excelexport_merge.xls");
			workbook.write(fos);
			fos.close();
	...
	public void test_many() {
		try {
			...
			Workbook workbook = ExcelExportUtil.exportExcel(params, entity,
					list);
			FileOutputStream fos = new FileOutputStream(
					"src/test/resources/com/delicacy/oatmeal/easypoi/excel/util/excelexport_many.xls");
			workbook.write(fos);
			fos.close();
		} catch (FileNotFoundException e) {
			e.printStackTrace();
	...
	public void test_date() throws Exception {
		...
		Workbook workbook = ExcelExportUtil.exportExcel(exportParams,
				CourseEntity.class, list);
		FileOutputStream fos = new FileOutputStream(
				"src/test/resources/com/delicacy/oatmeal/easypoi/excel/util/excelexport_date.xls");
		workbook.write(fos);
		fos.close();
	}
