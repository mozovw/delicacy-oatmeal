...
package com.delicacy.oatmeal.guava.demo.leakybucket;
...
public class Bucket {
    ...
    private Monitor.Guard offerMonitorGuard = new Monitor.Guard(offerMonitor) {
        @Override
    ...
    private Monitor.Guard consumerMonitorGuard = new Monitor.Guard(offerMonitor) {
        @Override
        public boolean isSatisfied() {
    ...
    public void submit(Integer data){
        ...
        if (offerMonitor.enterIf(offerMonitorGuard)){
            try {
    ...
    public void takeThenConsumer(Consumer<Integer> consumer){
        if (consumerMonitor.enterIf(consumerMonitorGuard)){
            try {
