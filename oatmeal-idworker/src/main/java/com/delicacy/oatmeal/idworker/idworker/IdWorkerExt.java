...
public class IdWorkerExt {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("---------------");
        for (int i = 0; i < 10; i++) {
            System.out.println("IdWorkerExt 01:"+iw1.nextId());
            System.out.println("IdWorkerExt 02:"+iw2.nextId());
            System.out.println("IdWorkerExt 03:"+iw3.nextId());
        }
    }
}   